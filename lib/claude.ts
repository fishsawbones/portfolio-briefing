...
import type { Position } from "./sheets";
import type { PriceData } from "./yahoo";
 ...
 */
function formatDataForPrompt(positions: EnrichedPosition[]): string {
  const byBasket = new Map<string, EnrichedPosition[]>();
